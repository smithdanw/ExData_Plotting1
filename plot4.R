...
plot(power$DateTimeSeconds, y = power$Voltage, type = "l", pch = 20, xlim = c(min, max), ylab = "Voltage", xlab = "datetime")
...
plot(power$DateTimeSeconds, y = power$Global_reactive_power, type = "l", pch = 20, xlim = c(min, max), ylab = "Global_reactive_power", xlab = "datetime")
